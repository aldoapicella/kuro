...
| Virtual custody workflow | Passed with the clean committed worker in one Ubuntu VM using two isolated Linux network namespaces and a direct veth link. Separate peer processes/databases, output-default-drop gates and failed external TCP controls. |
